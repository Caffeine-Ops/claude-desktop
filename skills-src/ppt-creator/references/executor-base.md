...
```bash
ls skills/ppt-creator/templates/icons/chunk-filled/ | grep home
ls skills/ppt-creator/templates/icons/tabler-filled/ | grep home
ls skills/ppt-creator/templates/icons/tabler-outline/ | grep chart
ls skills/ppt-creator/templates/icons/phosphor-duotone/ | grep house
ls skills/ppt-creator/templates/icons/simple-icons/ | grep github
```
