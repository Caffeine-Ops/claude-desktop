...
import { identifyProposalStageConfirm } from '@shared/proposal'
...
export function InlinePermissionPrompt({ request }: Props): React.JSX.Element {
  ...
  if (isAskUserQuestion) {
    ...
    return (
      ...
      >
        {stage && (
          <div className="border-b border-black/[0.06] bg-primary/5 px-3 py-2 text-[12px] leading-snug text-muted-foreground dark:border-white/[0.06]">
