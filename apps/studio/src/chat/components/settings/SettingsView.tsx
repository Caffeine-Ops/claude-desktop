...
/**
 * General settings category — interface language toggle. The CLI backend
 * picker that used to live here moved to the canvas settings overlay's
 * execution section (canvas SettingsDialog/CliBackendCard.tsx, 2026-07-16)
 * so the choice lives in one place; this legacy in-chat overlay keeps
