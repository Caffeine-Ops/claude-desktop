...
const STRINGS = {
  zh: {
    ...
    skillCaseTitle: '不知道做什么，试试最佳实践案例',
    skillCaseShuffle: '换一批',
    skillCaseOpen: '查看案例',
    skillCaseUsePrompt: '用这个提示词试试',
    skillCasePromptLabel: '提示词',
    skillCasePrev: '上一张',
    skillCaseNext: '下一张',
  ...
  en: {
    ...
    skillCaseTitle: 'Not sure what to make? Try a best-practice example',
    skillCaseShuffle: 'Show more',
    skillCaseOpen: 'View example',
    skillCaseUsePrompt: 'Try this prompt',
    skillCasePromptLabel: 'Prompt',
    skillCasePrev: 'Previous',
    skillCaseNext: 'Next',
