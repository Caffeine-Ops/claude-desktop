...
export const zhCN: Dict = {
  ...
  'settings.cliBackendSystemTitle': '系统 Claude Code',
  'settings.cliBackendSystemDesc': '使用本机安装的 claude 命令，按 ~/.claude 配置运行',
  'settings.cliBackendDetected': '已检测到',
  'settings.cliBackendNotInstalled': '未检测到本机安装的 claude',
  'settings.cliBackendDesktopOnly': 'CLI 后端选择仅在桌面应用内可用。',
  'settings.modeDaemonBackendMeta': 'fusion-code / 系统 claude',
  ...
  'settings.appearanceThemeMode': "主题模式",
  'settings.appearanceHint': '选择浅色、深色或跟随系统设置。',
  'settings.appearanceAndLanguage': '外观与语言',
  'settings.appearanceAndLanguageHint': '主题、字号、背景与界面语言',
  'settings.legacyThemeOverrides': '旧版本设置的自定义配色仍在生效',
  'settings.legacyThemeOverridesHint': '这是你在旧设置页里调过的背景 / 文字颜色、对比度和侧栏半透明。现在没有编辑入口了，点恢复即可回到默认（主题色保留）。',
  'settings.legacyThemeOverridesReset': '恢复默认',
  ...
  'settings.background.importing': '导入中…',
  'settings.background.scrim': '遮罩强度',
  'settings.background.focus': '构图焦点',
  'settings.background.applyAccent': '应用图片配色',
  'settings.background.delete': '删除主题',
  ...
  'settings.mediaProviderHint.grokNativeAudio': 'grok-imagine — 出图、出视频，视频自带原生音轨',
  'settings.mediaProviderHint.localHtmlRenderer': '本地 HTML → MP4 渲染器',
  'settings.mediaProviderHint.googleOfficialGateway': '默认走 Google 官方接口，也可自行配置中转网关',
  'settings.mediaProviderHint.openaiCompatRouting': 'OpenAI 兼容接口，出图与出视频统一路由',
  'settings.mediaProviderHint.openaiCompatEndpoint': 'OpenAI 兼容的 /v1/images/generations 接口',
  'settings.mediaProviderHint.musicGeneration': '音乐生成',
  'settings.mediaProviderHint.voiceSfx': '人声 / 音效',
  'settings.mediaProviderHint.speechVoiceClone': '语音合成 / 声音克隆',

  'settings.xaiOauth.signedIn': '已通过 X 登录。',
  'settings.xaiOauth.signedInExpiry': 'SuperGrok 订阅令牌将于 {expires} 过期。现在可以关掉已打开的 xAI 浏览器标签页了。',
  'settings.xaiOauth.signedInConnected': 'SuperGrok 订阅已连接。现在可以关掉已打开的 xAI 浏览器标签页了。',
  'settings.xaiOauth.awaiting': '等待授权…',
  'settings.xaiOauth.awaitingHint': '{brand} 正在后台等待回调。你在 xAI 页面点同意后，这个面板会在几秒内变成「已登录」。',
  'settings.xaiOauth.notSignedIn': '尚未登录。',
  'settings.xaiOauth.notSignedInHint': '点「用 X 登录」，即可在 {brand} 里用你的 SuperGrok 订阅跑 Grok 出图、视频和语音合成，不需要 API key。',
  'settings.xaiOauth.warningLead': '注意：',
  'settings.xaiOauth.warningBody': 'xAI 可能会弹出一个写着「无法建立连接」的页面。那是 xAI 那边的界面 bug——授权其实仍在后台送达 {brand}。留在本面板别动，它会自动变成「已登录」；不要在 xAI 的页面上重试。',
  'settings.xaiOauth.signIn': '用 X 登录',
  'settings.xaiOauth.openingBrowser': '正在打开浏览器…',
  'settings.xaiOauth.reconnect': '重新连接',
  'settings.xaiOauth.reconnectTitle': '重新授权（会替换掉现有令牌）',
  'settings.xaiOauth.connecting': '连接中…',
  'settings.xaiOauth.disconnect': '断开连接',
  'settings.xaiOauth.disconnecting': '正在断开…',
  'settings.xaiOauth.disconnectFailed': '断开失败，请查看 daemon 日志。',
  'settings.xaiOauth.refreshStatus': '刷新状态',
  'settings.xaiOauth.checking': '检查中…',
  'settings.xaiOauth.fallbackPrompt': '浏览器标签页没弹出来？',
  'settings.xaiOauth.fallbackLink': '手动打开授权页面',
  'settings.xaiOauth.pasteHint': 'xAI 有时不会跳回来，而是直接显示一串授权码。把它粘到这里：',
  'settings.xaiOauth.pastePlaceholder': '粘贴 xAI 给的授权码',
  'settings.xaiOauth.submitCode': '提交授权码',
  'settings.xaiOauth.submitting': '提交中…',
  'settings.xaiOauth.grantedScopes': '已授予的权限范围：',
  ...
  'settings.aboutAndUpdateHint': '版本信息、更新检查与问题反馈',
  'settings.appUpdate': '更新应用',
  'settings.appUpdateHint': '检查并安装新版本',
  'updateApp.subtitle': '检查并获取新版本，与菜单栏中的「检查更新」一致。',
  ...
  'updateApp.checking': '正在检查是否有新版本…',
  'updateApp.upToDate': '已是最新版本',
  'updateApp.downloading': '正在下载 {version}…',
  'updateApp.downloadHint': '下载完成后会提示你重启安装，期间可继续使用。',
  'updateApp.ready': '{version} 已下载完成，重启应用即可完成安装。',
  'updateApp.installNow': '立即重启更新',
  'updateApp.installing': '正在安装…',
  'updateApp.installingHint': '应用马上会关闭，装好后自己重新打开，不用手动操作。',
  'updateApp.retry': '重试',
  'updateApp.error': '检查更新失败',
  'updateApp.devUnavailable': '开发模式下不可用，打包安装后的应用才能检查更新。',
  'updateApp.browserUnavailable': '需在桌面应用内使用。',
  'updateApp.badge.latest': '已是最新',
  'updateApp.badge.checking': '检查中',
  'updateApp.badge.downloading': '下载中',
  'updateApp.badge.ready': '待安装',
  'updateApp.badge.installing': '安装中',
  'updateApp.badge.error': '检查失败',
  ...
  'mcpClient.unsavedChanges': '有改动还没保存',
  'mcpClient.forwardedTo': '已发给',
  'mcpClient.notForwardedTo': '没发给',
  'mcpClient.stdioOnly': '仅 stdio',
  'mcpClient.howToConfigure': '这些怎么配置？',
  'mcpClient.notForwardedHelp':
    '这些智能体要在它们自己的配置文件里单独配置 MCP 服务器，比如',
  'mcpClient.acpStdioHelp':
    '标着「仅 stdio」的智能体只接收 stdio 类型的服务器，HTTP 和 SSE 的条目在启动时会被丢掉。',
  'mcpClient.rowEnabled': '已开启',
  'mcpClient.rowDisabled': '已关闭',
  'mcpClient.rowMore': '更多操作',
  'mcpClient.rowMoveUp': '上移',
  'mcpClient.rowMoveDown': '下移',
  'mcpClient.rowRemove': '删除服务器',
  'mcpClient.templateHomepage': '模板主页',
  'mcpClient.templateTry': '试试：',
  ...
  'automations.kicker': '定时智能体会话',
  'automations.title': '自动化',
  'automations.lede': '为项目工作、Orbit 摘要和实时产物安排周期性对话。',
  ...
  'automations.yours': '你的自动化',
  'automations.loading': '加载中',
  'automations.emptyTitle': '还没有自动化',
  'automations.emptyBody': '从模板创建一个，或从空白计划开始。',
  'automations.statusPaused': '已暂停',
  'automations.manualOnly': '仅手动',
  'automations.scheduled': '已排期',
  'automations.nextRun': '下次 {when}',
  'automations.newProjectEachRun': '每次运行新建项目',
  'automations.lastRun': '上次运行 {when}',
  'automations.openResult': '打开结果',
  'automations.run': '运行',
  'automations.runNowTitle': '立即运行并打开对话',
  'automations.history': '历史',
  'automations.hideHistory': '收起历史',
  'automations.pause': '暂停',
  'automations.resume': '恢复',
  'automations.deleteAria': '删除自动化',
  'automations.deleteTitle': '删除这条自动化',
  'automations.deleteConfirm': '删除这条自动化？过往运行及其项目会保留。',
  'automations.proposalsTitle': '演进提案',
  'automations.proposalsSub': '在自动化产出写入记忆、技能或设计系统之前先审阅。',
  'automations.pendingCount': '{count} 条待审',
  'automations.apply': '应用',
  'automations.reject': '拒绝',
  'automations.targetMemory': '记忆',
  'automations.targetDesignSystem': '设计系统',
  'automations.targetSkill': '技能',
  'automations.targetTemplate': '自动化模板',
  'automations.actionCreate': '新建',
  'automations.actionUpdate': '更新',
  'automations.actionMerge': '合并',
  'automations.actionMove': '移动',
  'automations.actionPromote': '晋升',
  'automations.ingestTitle': '摄取来源',
  'automations.ingestSub': '把连接器、仓库、产物或聊天上下文转成可审阅的演进提案。',
  'automations.recentCount': '最近 {count} 条',
  'automations.fieldTemplate': '模板',
  'automations.fieldSource': '来源',
  'automations.fieldCompression': '压缩',
  'automations.fieldConnector': '连接器',
  'automations.anyConnectedSource': '任意已连接来源',
  'automations.fieldTitle': '标题',
  'automations.fieldSourceRef': '来源引用',
  'automations.fieldContent': '内容',
  'automations.titlePlaceholder': '决策、品牌笔记、工作流模式…',
  'automations.sourceRefPlaceholder': 'URL、仓库路径、连接器事件 ID、产物 ID…',
  'automations.contentPlaceholder': '粘贴内容，将其规范化为来源包与提案。',
  'automations.recentPacketsAria': '最近的来源包',
  'automations.noPackets': '还没有来源包。',
  'automations.packetMeta': '{kind} · {tokens} tokens',
  'automations.ingest': '摄取',
  'automations.ingesting': '摄取中',
  'automations.ingestEmptyError': '请先粘贴来源内容再摄取。',
  'automations.sourceConnector': '连接器',
  'automations.sourceUrl': 'URL',
  'automations.sourceRepo': '仓库',
  'automations.sourceArtifact': '产物',
  'automations.sourceChat': '聊天',
  'automations.sourceUpload': '上传',
  'automations.compressionBalanced': '均衡',
  'automations.compressionAggressive': '激进',
  'automations.compressionOff': '关闭',
  'automations.templatesTitle': '模板',
  'automations.templatesSub': 'Orbit 与实时产物也是同一自动化流程里的模板。',
  'automations.templatesCount': '{shown} / {total}',
  'automations.templateFiltersAria': '模板筛选',
  'automations.filterAll': '全部',
  'automations.filterOrbit': 'Orbit',
  'automations.filterLiveArtifacts': '实时产物',
  ...
  'automations.templatesEmptyTitle': '该分类下暂无模板。',
  'automations.templatesEmptyBody': '换个筛选条件，或从空白自动化开始。',
  'automations.kindOrbit': 'Orbit',
  'automations.kindLiveArtifact': '实时产物',
  ...
  'automations.historyLoading': '正在加载运行历史…',
  'automations.historyEmpty': '还没有运行记录。',
  'automations.historyAria': '自动化运行历史',
  'automations.historyTitle': '运行历史',
  'automations.historyLatest': '最近 10 条',
  'automations.openConversation': '打开对话',
  'automations.crystallize': '沉淀为技能',
  'automations.crystallizing': '沉淀中',
  'automations.crystallizeTitle': '从这次运行起草技能与记忆提案',
};
