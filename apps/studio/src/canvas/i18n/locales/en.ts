...
export const en: Dict = {
  ...
  'settings.cliBackendSystemTitle': 'System Claude Code',
  'settings.cliBackendSystemDesc': 'Use the claude binary installed on your machine, under your own ~/.claude config',
  'settings.cliBackendDetected': 'Detected',
  'settings.cliBackendNotInstalled': 'No system claude detected',
  'settings.cliBackendDesktopOnly': 'The CLI backend switch is only available inside the desktop app.',
  'settings.modeDaemonBackendMeta': 'fusion-code / system claude',
  ...
  'settings.appearanceThemeMode': "Theme mode",
  ...
  'settings.appearanceAndLanguageHint': 'Theme, font size, background, and interface language',
  'settings.legacyThemeOverrides': 'Custom colors from an earlier version are still active',
  'settings.legacyThemeOverridesHint': 'Background and text colors, contrast, and sidebar translucency you set in the old settings page. There is no editor for them anymore; reset to return to the defaults (your accent color is kept).',
  'settings.legacyThemeOverridesReset': 'Reset to defaults',
  ...
  'settings.background.importing': 'Importing…',
  'settings.background.scrim': 'Veil strength',
  'settings.background.focus': 'Focal point',
  'settings.background.applyAccent': 'Apply photo colors',
  'settings.background.delete': 'Delete theme',
  ...
  'settings.mediaProviderHint.grokNativeAudio': 'grok-imagine — image + video with native audio',
  'settings.mediaProviderHint.localHtmlRenderer': 'Local HTML -> MP4 renderer',
  'settings.mediaProviderHint.googleOfficialGateway': 'Google official by default; custom gateway configurable',
  'settings.mediaProviderHint.openaiCompatRouting': 'OpenAI-compatible image + video routing',
  'settings.mediaProviderHint.openaiCompatEndpoint': 'OpenAI-compatible /v1/images/generations endpoint',
  'settings.mediaProviderHint.musicGeneration': 'Music generation',
  'settings.mediaProviderHint.voiceSfx': 'Voice / SFX',
  'settings.mediaProviderHint.speechVoiceClone': 'Speech / voice clone',

  'settings.xaiOauth.signedIn': 'Signed in with X.',
  'settings.xaiOauth.signedInExpiry': 'SuperGrok subscription token expires {expires}. You can close any open xAI browser tabs now.',
  'settings.xaiOauth.signedInConnected': 'SuperGrok subscription connected. You can close any open xAI browser tabs now.',
  'settings.xaiOauth.awaiting': 'Waiting for authorization…',
  'settings.xaiOauth.awaitingHint': '{brand} is listening for the callback in the background. This panel will switch to “signed in” within a few seconds of your approving on xAI.',
  'settings.xaiOauth.notSignedIn': 'Not signed in.',
  'settings.xaiOauth.notSignedInHint': 'Click “Sign in with X” to use your SuperGrok subscription for Grok image, video and TTS in {brand} — no API key needed.',
  'settings.xaiOauth.warningLead': 'Heads up:',
  'settings.xaiOauth.warningBody': 'xAI may show a page saying “Cannot connect to your application”. That is a UX bug on xAI’s side — the authorization is still being delivered to {brand} in the background. Stay on this panel; it will switch to “signed in” automatically. Do not retry from xAI’s page.',
  'settings.xaiOauth.signIn': 'Sign in with X',
  'settings.xaiOauth.openingBrowser': 'Opening browser…',
  'settings.xaiOauth.reconnect': 'Reconnect',
  'settings.xaiOauth.reconnectTitle': 'Re-authenticate (replaces the existing token)',
  'settings.xaiOauth.connecting': 'Connecting…',
  'settings.xaiOauth.disconnect': 'Disconnect',
  'settings.xaiOauth.disconnecting': 'Disconnecting…',
  'settings.xaiOauth.disconnectFailed': 'Disconnect failed. Check the daemon logs.',
  'settings.xaiOauth.refreshStatus': 'Refresh status',
  'settings.xaiOauth.checking': 'Checking…',
  'settings.xaiOauth.fallbackPrompt': 'Browser tab didn’t open?',
  'settings.xaiOauth.fallbackLink': 'Open the authorization page manually',
  'settings.xaiOauth.pasteHint': 'xAI may show a code instead of redirecting back. Paste it here:',
  'settings.xaiOauth.pastePlaceholder': 'Paste the auth code from xAI',
  'settings.xaiOauth.submitCode': 'Submit code',
  'settings.xaiOauth.submitting': 'Submitting…',
  'settings.xaiOauth.grantedScopes': 'Granted scopes:',
  ...
  'settings.aboutAndUpdateHint': 'Version info, update checks, and feedback',
  'settings.appUpdate': 'App Updates',
  'settings.appUpdateHint': 'Check for and install new versions',
  'updateApp.subtitle': 'Check for new versions — same as "Check for Updates" in the menu bar.',
  ...
  'updateApp.checking': 'Checking for a new version…',
  'updateApp.upToDate': 'You are up to date',
  'updateApp.downloading': 'Downloading {version}…',
  'updateApp.downloadHint': 'You will be prompted to restart once the download finishes. You can keep working meanwhile.',
  'updateApp.ready': '{version} has been downloaded — restart the app to finish installing.',
  'updateApp.installNow': 'Restart to update',
  'updateApp.installing': 'Installing…',
  'updateApp.installingHint': 'The app will close now and reopen on its own once the update is installed.',
  'updateApp.retry': 'Retry',
  'updateApp.error': 'Update check failed',
  'updateApp.devUnavailable': 'Unavailable in development mode — only packaged builds can check for updates.',
  'updateApp.browserUnavailable': 'Available in the desktop app only.',
  'updateApp.badge.latest': 'Up to date',
  'updateApp.badge.checking': 'Checking',
  'updateApp.badge.downloading': 'Downloading',
  'updateApp.badge.ready': 'Ready',
  'updateApp.badge.installing': 'Installing',
  'updateApp.badge.error': 'Failed',
  ...
  'mcpClient.unsavedChanges': 'You have unsaved changes',
  'mcpClient.forwardedTo': 'Sent to',
  'mcpClient.notForwardedTo': 'Not sent to',
  'mcpClient.stdioOnly': 'stdio only',
  'mcpClient.howToConfigure': 'How do I set these up?',
  'mcpClient.notForwardedHelp':
    'These agents need MCP servers configured in their own config file, for example',
  'mcpClient.acpStdioHelp':
    'Agents marked "stdio only" accept stdio servers from this list. HTTP and SSE entries are dropped when they start up.',
  'mcpClient.rowEnabled': 'On',
  'mcpClient.rowDisabled': 'Off',
  'mcpClient.rowMore': 'More actions',
  'mcpClient.rowMoveUp': 'Move up',
  'mcpClient.rowMoveDown': 'Move down',
  'mcpClient.rowRemove': 'Remove server',
  'mcpClient.templateHomepage': 'Homepage',
  'mcpClient.templateTry': 'Try:',
  ...
  // Automations（TasksView）
  'automations.kicker': 'Scheduled agent sessions',
  ...
  'automations.yours': 'Your automations',
  ...
  'automations.manualOnly': 'Manual only',
  'automations.scheduled': 'Scheduled',
  'automations.nextRun': 'Next {when}',
  'automations.newProjectEachRun': 'New project each run',
  'automations.lastRun': 'Last run {when}',
  ...
  'automations.pendingCount': '{count} pending',
  'automations.apply': 'Apply',
  'automations.reject': 'Reject',
  'automations.targetMemory': 'Memory',
  'automations.targetDesignSystem': 'Design system',
  'automations.targetSkill': 'Skill',
  'automations.targetTemplate': 'Automation template',
  'automations.actionCreate': 'Create',
  'automations.actionUpdate': 'Update',
  'automations.actionMerge': 'Merge',
  'automations.actionMove': 'Move',
  'automations.actionPromote': 'Promote',
  'automations.ingestTitle': 'Ingest source',
  'automations.ingestSub': 'Turn connector, repo, artifact, or chat context into reviewable evolution proposals.',
  'automations.recentCount': '{count} recent',
  'automations.fieldTemplate': 'Template',
  'automations.fieldSource': 'Source',
  'automations.fieldCompression': 'Compression',
  'automations.fieldConnector': 'Connector',
  'automations.anyConnectedSource': 'Any connected source',
  'automations.fieldTitle': 'Title',
  'automations.fieldSourceRef': 'Source ref',
  'automations.fieldContent': 'Content',
  'automations.titlePlaceholder': 'Decision, brand notes, workflow pattern...',
  'automations.sourceRefPlaceholder': 'URL, repo path, connector event id, artifact id...',
  'automations.contentPlaceholder': 'Paste the content to canonicalize into a source packet and proposals.',
  'automations.recentPacketsAria': 'Recent source packets',
  'automations.noPackets': 'No source packets yet.',
  'automations.packetMeta': '{kind} · {tokens} tokens',
  'automations.ingest': 'Ingest',
  'automations.ingesting': 'Ingesting',
  'automations.ingestEmptyError': 'Paste source content before ingesting it.',
  'automations.sourceConnector': 'Connector',
  'automations.sourceUrl': 'URL',
  'automations.sourceRepo': 'Repo',
  'automations.sourceArtifact': 'Artifact',
  'automations.sourceChat': 'Chat',
  'automations.sourceUpload': 'Upload',
  'automations.compressionBalanced': 'Balanced',
  'automations.compressionAggressive': 'Aggressive',
  'automations.compressionOff': 'Off',
  ...
  'automations.templatesCount': '{shown} of {total}',
  ...
  'automations.historyLoading': 'Loading run history...',
  'automations.historyEmpty': 'No runs yet.',
  'automations.historyAria': 'Automation run history',
  'automations.historyTitle': 'Run history',
  'automations.historyLatest': 'Latest 10',
